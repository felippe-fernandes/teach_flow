  ...
  return (
    <div className="space-y-6 max-w-4xl">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold">Novo Contratante</h1>
          <p className="text-muted-foreground">
            Adicione uma escola, plataforma ou cliente
          </p>
        </div>
      </div>
        ...
        <div className="space-y-6">
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select name="currency" defaultValue="BRL" required disabled={loading}>
                    <SelectTrigger>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select name="payment_frequency" defaultValue="monthly" required disabled={loading}>
                    <SelectTrigger>
          ...
          <div className="flex gap-4">
            <Button type="submit" disabled={loading}>
              {loading ? "Salvando..." : "Salvar Contratante"}
            </Button>
            <Link href="/dashboard/contractors">
